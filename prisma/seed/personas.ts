...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    courseOrder: ["sql-for-beginners", "python-basics", "git-github-basics", "javascript-fundamentals"],
    speed: 0.9,
    breadth: 2,
    completion: 0.8,
  ...
  {
    id: "pythonista",
    label: "Python-first (scripting into data)",
    courseOrder: ["python-basics", "sql-for-beginners", "javascript-fundamentals", "git-github-basics"],
    speed: 1.05,
    breadth: 2,
    completion: 0.82,
    chaptersPerSession: [2, 4],
  ...
  {
    id: "enterprise",
    label: "Enterprise / JVM track",
    courseOrder: ["java-basics", "git-github-basics", "sql-for-beginners"],
    speed: 0.85,
    breadth: 2,
    completion: 0.75,
    chaptersPerSession: [1, 3],
